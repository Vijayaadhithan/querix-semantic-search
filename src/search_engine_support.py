...
from database_store import fetch_product_types_by_ids, fetch_products_by_ids
...
from search_helpers import active_filter_names
...
def _engine_dependency(name: str, default):
    """Honor patches made through the public ``search_engine`` module."""
    engine_module = sys.modules.get("search_engine")
    return (
